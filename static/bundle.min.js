var Sudoku = (function (exports) {
      ...
      value: function accepts(input) {
        ...
        try {
          for (var _iterator = this.errors(validation, [], input)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var error = _step.value; // eslint-disable-line no-unused-vars
  ...
  var TypeInferer = function () {
    ...
    createClass(TypeInferer, [{
      ...
      value: function inferObject(input, inferred) {
        ...
        var context = this.context;
        var type = void 0; // Temporarily create a box for this type to catch cyclical references.
  ...
  var $KeysType = function (_Type) {
    ...
    return $KeysType;
  }(Type); // Map over the keys and values in an object.
  ...
  var $ObjMapiType = function (_Type) {
    ...
    return $ObjMapiType;
  }(Type); // Map over the keys in an object.
  ...
  var $ObjMapType = function (_Type) {
    ...
    return $ObjMapType;
  }(Type); // The type of the named object property
  ...
  var $PropertyType = function (_Type) {
    ...
    return $PropertyType;
  }(Type); // An object of type $Shape<T> does not have to have all of the properties
  ...
  var $SuperType = function (_Type) {
    ...
    return $SuperType;
  }(Type); // Map over the values in a tuple.
  ...
  function a(b) {
    var _bType = globalContext$2.number();

    globalContext$2.param("b", _bType).assert(b);
    console.log(b);
  }

  globalContext$2.annotate(a, globalContext$2.function(globalContext$2.param("b", globalContext$2.number())));
  a('foo');
